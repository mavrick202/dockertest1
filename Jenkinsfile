    ...
    stages {
        ...
        stage('Build Docker Image') {
          steps {
            ...
            sh 'docker build -t sreeharshav/pipelinetest:$BUILD_TIMESTAMP .'
            }
        }

        stage('Push Image to Docker Hub') {
          steps {
           sh    'docker push sreeharshav/pipelinetest:$BUILD_TIMESTAMP'
           }
        }
        ...
        stage('Deploy to Docker Host') {
          steps {
            ...
            sh    'docker -H tcp://10.1.1.200:2375 run --rm -dit --name webapp1 --hostname webapp1 -p 9000:80 sreeharshav/pipelinetest:$BUILD_TIMESTAMP'
            }
        }
